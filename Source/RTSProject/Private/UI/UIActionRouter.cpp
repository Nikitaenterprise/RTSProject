#include "UI/UIActionRouter.h"

#include "Widgets/SViewport.h"

void UUIActionRouter::ApplyUIInputConfig(const FUIInputConfig& NewConfig, bool bForceRefresh)
{
	...
	if (!GameViewportClient || !PC)
	{
		...
		UE_LOG(LogTemp, Error, TEXT("Missing GameViewportClient or PC"));
		return;
	}
	...
	auto isCaptured = [] (const EMouseCaptureMode& Mode) 
	{
		return Mode == EMouseCaptureMode::CapturePermanently || Mode == EMouseCaptureMode::CapturePermanently_IncludingInitialMouseDown; 
	};
