...
void UMiniMapWidget::Initialize(ARTSPlayerController* Controller)
{
	if (Controller) PlayerController = Controller;
	else
	{
		UE_LOG(LogTemp, Error, TEXT("PlayerController in UMiniMapWidget->Initialize is nullptr"));
		return;
	}
	...
	{
		UE_LOG(LogTemp, Error, TEXT("FOWBoundsVolume in UMiniMapWidget->Initialize is nullptr"));
		return;
	}
	...
	if (!DefaultIcon)
	{
		UE_LOG(LogTemp, Error, TEXT("DefaultIcon in UMiniMapWidget->Initialize is nullptr"));
		return;
	}
}
