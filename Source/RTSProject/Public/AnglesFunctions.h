...
public:
	...
	/// <returns>Returns angle in degrees between two vectors</returns>
	...
	/// <param name="v1">First vector</param>
	/// <param name="v2">Second vector</param>
	/// <returns>Angle to rotate in degrees (signed)</returns>
	...
	/// <returns>Rotator with pitch=0, roll=0, yaw=rotation angle in degrees</returns>
